...
const NotFound = () => {
  return (
    <section className="bg-[#003f6d] h-screen flex justify-center items-center border-t-4 border-[#003f6d]">
      <div className="container">
        <div className="flex flex-col gap-10 justify-center items-center text-white">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-white/80">La página que buscas no existe o ha sido movida.</p>
          </div>

          <Link
            href="/"
            className="group flex gap-3 items-center w-fit bg-white text-[#003f6d] hover:bg-[#005290] hover:text-white rounded-full transition-all duration-200 ease-in-out"
          >
            <span className="pl-6 pr-2 py-3 text-lg font-bold group-hover:translate-x-6 transform transition-transform duration-200 ease-in-out">
              Volver al inicio
            </span>
            <svg
